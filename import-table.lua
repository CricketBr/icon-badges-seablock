...
local bigtable_raw = require('bigtable-csv')

local bigtable_lines = csvtools.read_lines(bigtable_raw)

cb.sib.bigtable = csvtools.read_data_from_csv_lines(bigtable_lines)
