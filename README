...
We are open to submissions for full or partial sets. A submission needs the name of the new set (what players will turn on or off), and a csv file with the following columns.
```
